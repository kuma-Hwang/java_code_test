...
public class Point2D {
    private static int counter = 0;  //몇번까지 식별번호를 부여했는가?
    ...
    /*
    public Test02.Point2D() { }
    public Test02.Point2D(int x) { this.x = x; }
    public Test02.Point2D(int x, int y) { this.x = x; this.y = y; }*/

    //생성자
    public Point2D() {
        if(++counter == day) {
            System.out.print("당첨!!");
            System.out.printf("오늘 %d의 좌표가 생성됐습니다.\n",counter);
        }
    }
