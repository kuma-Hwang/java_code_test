...
public class DayTester {
    ...
    static void beforeAfter(Day day) {
        ...
        switch (type) {
            case 1:
                System.out.println(day.succeedingDay()); // 하루 뒤
                break;
            case 2:
                System.out.println(day.precedingDay()); // 하루 앞
                break;
            case 3:
    ...
    public static void main(String[] args) {
        ...
        int y = stdIn.nextInt();
        System.out.print("월: ");
        int m = DayTester.stdIn.nextInt();
        System.out.print("일: ");
        int d = stdIn.nextInt();

        Day day = new Day(); // 읽은 날짜
